...
urlpatterns = [
    ...
    path('account_details', HodViews.account_details,name="account_details"),
    ...
    path('staff_student_feedback_message_replied', StaffViews.staff_student_feedback_message_replied,name="staff_student_feedback_message_replied"),
